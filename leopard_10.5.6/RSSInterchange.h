...
- (void)dealloc;
- (id)init;
- (BOOL)fetchTemporaryFeedAtURL:(id)fp8 getName:(id *)fp12 getAutodiscoveredURL:(id *)fp16;
...
- (void)_subscribeToFeedWithURL:(id)fp8 login:(id)fp12 password:(id)fp16;
- (void)updateAuthenticationInfoForFeedWithTransporter:(id)fp8;
- (void)_updateAuthenticationInfoForFeedWithURL:(id)fp8 login:(id)fp12 password:(id)fp16;
...
- (void)_writeDate;
- (void)_addStoreForFeedBeingRefreshed:(id)fp8;
- (void)_removeStoreBeingRefreshedWithIdentifier:(id)fp8;
- (id)_storeBeingRefreshedWithIdentifier:(id)fp8;
- (void)_delegateFeedDidEndRefresh:(id)fp8;
- (id)_createPortComponentsForFeedURL:(id)fp8;
- (id)_createPortComponentsForFeedTransporter:(id)fp8;
